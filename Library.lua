--[[
    ...
    Modo de usar: local ui = loadstring(game:HttpGet("URL"))()
--]]
...
function TaskplusUI.CreateButton(parent, text, x, y, width, height, callback)
    local button = Instance.new("TextButton")
    button.Size = UDim2.new(0, width or 140, 0, height or 38)
    button.Position = UDim2.new(0, x or 0, 0, y or 0)
    button.Text = text
...
function TaskplusUI.CreateToggle(parent, labelText, x, y, defaultState, callback)
...
function TaskplusUI.CreateSlider(parent, labelText, x, y, width, min, max, default, callback)
    local frame = Instance.new("Frame")
    frame.Size = UDim2.new(0, width or 280, 0, 50)
    frame.Position = UDim2.new(0, x or 0, 0, y or 0)
    frame.BackgroundTransparency = 1
    frame.Parent = parent
...
function TaskplusUI.CreateInput(parent, placeholder, x, y, width, height, callback)
    local input = Instance.new("TextBox")
    input.Size = UDim2.new(0, width or 260, 0, height or 38)
    input.Position = UDim2.new(0, x or 0, 0, y or 0)
...
function TaskplusUI.CreateCard(parent, x, y, width, height, title)
    local card = Instance.new("Frame")
    card.Size = UDim2.new(0, width or 280, 0, height or 160)
...
function TaskplusUI.CreateSeparator(parent, x, y, width)
...
-- ============================================
-- EXPORTAR (RETORNA A TABELA DIRETAMENTE)
-- ============================================
